    ...
    <div className="relative min-h-screen flex flex-col items-center justify-start text-white overflow-hidden p-8">
      ...
      >
        ...
        <section className="w-full mb-8">
          <h2 className="text-2xl font-bold text-cyan-400 mb-4">Professional Experience</h2>
          <ul className="list-disc list-inside text-gray-300">
            <li>EPSM Georges Daumezon – Cybersecurity Officer (internship)</li>
            <li>Appliance repair - ENVIE (summer internship)</li>
          </ul>
        </section>
        ...
        <section className="w-full mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300">
            ...
            <li>Bachelor 3 – Admin, Security & Networks (2024/2025)</li>
            <li>Master 1 Cybersecurity (2025 – 2026)</li>
          </ul>
        </section>
        ...
        <section className="w-full mb-8">
          ...
          <ul className="list-disc list-inside text-gray-300">
            <li>Risk analysis, Active Directory hardening, access management, incidents & logs, IT policies, user awareness, IT collaboration</li>
            <li>Systems & Networks: Windows Server 2022, Exchange Server 2019, Ubuntu, Kali Linux, Cisco, VMware</li>
            <li>Cybersecurity: risk analysis, auditing, pentesting, ethical hacking, cloud security</li>
            <li>Databases: DBMS and database management</li>
            <li>Tools & Monitoring: Cisco Packet Tracer, Zabbix, Nagios, Microsoft Office</li>
            <li>Methodologies & Practices: DevOps, tech monitoring</li>
          </ul>
        </section>
