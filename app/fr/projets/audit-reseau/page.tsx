...
export default function AuditReseau() {
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-start text-white p-8 overflow-hidden">
      ...
      >
        ...
        <motion.p className="text-gray-400 text-center max-w-2xl mb-6 drop-shadow-[0_0_10px_#0ff]">
          Audit complet du réseau interne de l'hôpital Georges Daumezon pour détecter les vulnérabilités et améliorer la sécurité.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-8">
          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Infrastructure</h3>
            <p className="text-gray-300 text-sm">Évaluation des switches, routeurs et firewalls.</p>
          </motion.div>
          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Vulnérabilités</h3>
            <p className="text-gray-300 text-sm">Identification des failles de sécurité potentielles.</p>
          </motion.div>
          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Rapport</h3>
            <p className="text-gray-300 text-sm">Recommandations et plan d'action pour corriger les risques.</p>
          </motion.div>
          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Collaboration</h3>
            <p className="text-gray-300 text-sm">Travail avec l'équipe TI pour mettre en œuvre les changements.</p>
          </motion.div>
        </div>
