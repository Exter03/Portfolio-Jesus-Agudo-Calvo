...
export default function AboutMeEs() {
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-start text-white overflow-hidden p-8">
      ...
      >
        ...
        <section className="w-full mb-8">
          <h2 className="text-2xl font-bold text-cyan-400 mb-4">Experiencias Profesionales</h2>
          <ul className="list-disc list-inside text-gray-300">
            <li>EPSM Georges Daumezon – Encargado de cybersécurité (practicas)</li>
            <li>Reparador de electrodomésticos - ENVIE (practicas de verano)</li>
          </ul>
        </section>

        {/* Formaciones */}
        <section className="w-full mb-8">
          <h2 className="text-2xl font-bold text-cyan-400 mb-4">Formaciones</h2>
          <ul className="list-disc list-inside text-gray-300">
        ...
        <section className="w-full mb-8">
          <h2 className="text-2xl font-bold text-cyan-400 mb-4">Competencias Técnicas</h2>
          <ul className="list-disc list-inside text-gray-300">
            <li>Análisis de riesgos, securización Active Directory, gestión de accesos, incidentes y logs, PSSI, sensibilización de usuarios, colaboración IT</li>
            <li>Sistemas & Redes: Windows Server 2022, Exchange Server 2019, Ubuntu, Kali Linux, Cisco, VMware</li>
            <li>Cyberseguridad: análisis de riesgos, auditoría y pentesting, hacking ético, seguridad cloud</li>
            <li>Bases de datos: SGBD y gestión de bases de datos</li>
            <li>Herramientas & Monitoring: Cisco Packet Tracer, Zabbix, Nagios, Microsoft Office</li>
            <li>Métodos & Prácticas: DevOps, vigilancia tecnológica</li>
          </ul>
        </section>
        ...
        <motion.button
          ...
          whileHover={{
            scale: 1.1,
            boxShadow: "0 0 30px #0ff, 0 0 60px #0ff",
          }}
          whileTap={{ scale: 0.95 }}
