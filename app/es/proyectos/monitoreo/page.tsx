    ...
    <div className="relative min-h-screen flex flex-col items-center justify-start text-white p-8 overflow-hidden">
      ...
      >
        ...
        <motion.p className="text-gray-400 text-center max-w-2xl mb-6 drop-shadow-[0_0_10px_#0ff]">
          Implementación de sistemas de monitoreo en tiempo real para detectar amenazas y anomalías en la red del hospital.
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-8">
          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Alertas automáticas</h3>
            <p className="text-gray-300 text-sm">Notificaciones en tiempo real para incidentes críticos.</p>
          </motion.div>

          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Dashboards de control</h3>
            <p className="text-gray-300 text-sm">Visualización de estado de la red y actividad sospechosa.</p>
          </motion.div>

          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Mitigación de riesgos</h3>
            <p className="text-gray-300 text-sm">Implementación de medidas preventivas y correctivas.</p>
          </motion.div>

          <motion.div className="bg-gray-900 p-6 rounded-2xl shadow-[0_0_20px_#0ff] hover:shadow-[0_0_40px_#0ff] transition-all duration-300">
            <h3 className="text-xl font-bold text-cyan-400 mb-2">Colaboración TI</h3>
            <p className="text-gray-300 text-sm">Trabajo conjunto con el equipo de TI para mantener seguridad continua.</p>
          </motion.div>
        </div>
